...
module.exports = {
	...
	// how to manage them [here](https://thelounge.chat/docs/plugins/themes.html).
	//
	...
	// - `rejectUnauthorized`: Whether or not the server certificate should be
	//   verified against the list of supplied CAs by your Node.js installation.
	...
	// `[]`. Logging is also controlled per user individually in the `logs` key of
